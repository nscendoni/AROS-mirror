...
#
# $Id: cd2po.sh 49325 2014-08-14 00:52:39Z mazze $
#
...
BEGIN {
  ...
  print "# $Id: cd2po.sh 49325 2014-08-14 00:52:39Z mazze $"
  print "#"
...
}
{
  if(firsttag == 0)
  {
    ...
    {
      revision=$4 # get revision out of $Id: cd2po.sh 49325 2014-08-14 00:52:39Z mazze $ SVN keyword
      next
    }
    else if($0 ~ /^## language .*/)
    {
