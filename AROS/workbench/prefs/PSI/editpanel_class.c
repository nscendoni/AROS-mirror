...
CONST_STRPTR CYA_EditPages[] =
{
    (CONST_STRPTR)MSG_EDITPAGE_ATTRIBUTES,
    (CONST_STRPTR)MSG_EDITPAGE_DISPLAY,
    (CONST_STRPTR)MSG_EDITPAGE_COLORS,
    NULL
};

CONST_STRPTR CYA_Overscan[] =
{
    (CONST_STRPTR)MSG_OVERSCAN_TEXT,
    (CONST_STRPTR)MSG_OVERSCAN_GRAPHICS,
    (CONST_STRPTR)MSG_OVERSCAN_EXTREME,
    (CONST_STRPTR)MSG_OVERSCAN_MAXIMUM,
    NULL
};
