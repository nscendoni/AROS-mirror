...
BOOL HIDD_USB_AttachDriver(OOP_Object *obj, OOP_Object *driver)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USB, moHidd_USB_AttachDriver);
...
BOOL HIDD_USB_DetachDriver(OOP_Object *obj, OOP_Object *driver)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USB, moHidd_USB_DetachDriver);
...
void HIDD_USB_AddClass(OOP_Object *obj, const char *className)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USB, moHidd_USB_AddClass);
...
uint8_t HIDD_USB_AllocAddress(OOP_Object *obj, OOP_Object *driver)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USB, moHidd_USB_AllocAddress);
...
void HIDD_USB_FreeAddress(OOP_Object *obj, OOP_Object *driver, uint8_t address)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USB, moHidd_USB_FreeAddress);
...
OOP_Object *HIDD_USB_NewDevice(OOP_Object *obj, OOP_Object *hub, BOOL fast)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USB, moHidd_USB_NewDevice);
...
BOOL HIDD_USBDevice_GetDescriptor(OOP_Object *obj, uint8_t type, uint8_t index, uint16_t length, APTR descriptor)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetDescriptor);
...
BOOL HIDD_USBDevice_GetConfigDescriptor(OOP_Object *obj, uint8_t index, usb_config_descriptor_t *descriptor)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetConfigDescriptor);
...
BOOL HIDD_USBDevice_GetDeviceDescriptor(OOP_Object *obj, usb_device_descriptor_t *descriptor)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetDeviceDescriptor);
...
BOOL HIDD_USBDevice_GetStatus(OOP_Object *obj, usb_status_t *status)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetStatus);
...
BOOL HIDD_USBDevice_GetString(OOP_Object *obj, int8_t id, uint16_t language, usb_string_descriptor_t *string)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetString);
...
void * HIDD_USBDevice_CreatePipe(OOP_Object *obj, enum USB_PipeType type, uint8_t endpoint, uint8_t period, uint16_t maxpacket, uint32_t timeout)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_CreatePipe);
...
void HIDD_USBDevice_DeletePipe(OOP_Object *obj, APTR pipe)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_DeletePipe);
...
void HIDD_USBDevice_SetTimeout(OOP_Object *obj, APTR pipe, uint32_t timeout)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_SetTimeout);
...
BOOL HIDD_USBDevice_ControlMessage(OOP_Object *obj, APTR pipe, USBDevice_Request *request, APTR buffer, uint32_t length)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_ControlMessage);
...
BOOL HIDD_USBDevice_BulkTransfer(OOP_Object *obj, APTR pipe, APTR buffer, uint32_t length)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_BulkTransfer);
...
BOOL HIDD_USBDevice_Configure(OOP_Object *obj, uint8_t configNr)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_Configure);
...
usb_interface_descriptor_t *HIDD_USBDevice_GetInterface(OOP_Object *obj, uint8_t interface)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetInterface);
...
usb_endpoint_descriptor_t *HIDD_USBDevice_GetEndpoint(OOP_Object *obj, uint8_t interface, uint8_t endpoint)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDevice, moHidd_USBDevice_GetEndpoint);
...
BOOL HIDD_USBHub_OnOff(OOP_Object *obj, BOOL on)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_OnOff);
...
BOOL HIDD_USBHub_PortEnable(OOP_Object *obj, uint8_t port, BOOL enable)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_PortEnable);
...
BOOL HIDD_USBHub_PortReset(OOP_Object *obj, uint8_t port)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_PortReset);
...
BOOL HIDD_USBHub_GetPortStatus(OOP_Object *obj, uint8_t port, usb_port_status_t *status)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_GetPortStatus);
...
BOOL HIDD_USBHub_GetHubStatus(OOP_Object *obj, usb_hub_status_t *status)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_GetHubStatus);
...
BOOL HIDD_USBHub_ClearHubFeature(OOP_Object *obj, int feature)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_ClearHubFeature);
...
BOOL HIDD_USBHub_SetHubFeature(OOP_Object *obj, int feature)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_SetHubFeature);
...
BOOL HIDD_USBHub_ClearPortFeature(OOP_Object *obj, uint8_t port, int feature)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_ClearPortFeature);
...
BOOL HIDD_USBHub_SetPortFeature(OOP_Object *obj, uint8_t port, int feature)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_SetPortFeature);
...
BOOL HIDD_USBHub_GetHubDescriptor(OOP_Object *obj, usb_hub_descriptor_t *descriptor)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_GetHubDescriptor);
...
OOP_Object *HIDD_USBHub_GetChild(OOP_Object *obj, uint8_t port)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBHub, moHidd_USBHub_GetChild);
        ...
        BOOL fullspeed, uint8_t address, uint8_t endpoint, uint8_t period, uint32_t maxpacket, uint32_t timeout)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_CreatePipe);
...
void HIDD_USBDrv_DeletePipe(OOP_Object *obj, APTR pipe)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_DeletePipe);
...
void HIDD_USBDrv_SetTimeout(OOP_Object *obj, APTR pipe, uint32_t timeout)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_SetTimeout);
        ...
        APTR buffer, uint32_t length)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_ControlTransfer);
...
BOOL HIDD_USBDrv_BulkTransfer(OOP_Object *obj, APTR pipe, APTR buffer, uint32_t length)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_BulkTransfer);
...
BOOL HIDD_USBDrv_AddInterrupt(OOP_Object *obj, void *pipe, void *buffer, uint8_t length, struct Interrupt *interrupt)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_AddInterrupt);
...
BOOL HIDD_USBDrv_RemInterrupt(OOP_Object *obj, void *pipe, struct Interrupt *interrupt)
{
    ...
    if (!static_mid) static_mid = OOP_GetMethodID((STRPTR)IID_Hidd_USBDrv, moHidd_USBDrv_RemInterrupt);
