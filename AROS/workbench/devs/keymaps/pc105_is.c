...
/*
    ...
    $Id: pc105_is.c 51236 2015-12-19 16:58:58Z polluks $
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0x93,0xB0,0xA8,0xB0),
    BYTES(0x94,0x84,'!' ,'1' ),
    BYTES(0x99,0xA1,0x22,'2' ),
    BYTES(0xB6,0xA3,'#' ,'3' ),
    BYTES(0xA3,'$' ,'$' ,'4' ),
    BYTES(0xBC,0x80,'%' ,'5' ),
    BYTES(0xBD,0,   '&' ,'6' ),
    ...
    BYTES(0xD8,0xF8,'O' ,'o' ),
    BYTES(0,   0xBF,'P' ,'p' ),
    BYTES(0xB0,0x98,0xD0,0xF0),
    BYTES(0xB1,0x7E,'?' ,0x27),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES(0,   0,   'K' ,'k' ),
    BYTES(0,   0xAC,'L' ,'l' ),
    BYTES(0x8C,0x9C,0xC6,0xE6),
    BYTES(0,   0x5E,0xB4,0xB4),
    BYTES(0,   0x60,'*' ,'+' ),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
