// Kbdca_FrenchCanadian_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_cdn.c 51236 2015-12-19 16:58:58Z polluks $
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0x93,0x5C,0x7C,'#' ),
    BYTES(0x94,0xB1,'!' ,'1' ),
    BYTES(0x99,'@' ,0x22,'2' ),
    BYTES(0xB6,0xA3,0x2F,'3' ),
    BYTES(0xA3,0xA2,'$' ,'4' ),
    BYTES(0xBC,0xA4,'%' ,'5' ),
    BYTES(0xBD,0xAC,'?' ,'6' ),
    BYTES(0xBE,0xA6,'&' ,'7' ),
    ...
    BYTES(0,   0xA7,'O' ,'o' ),
    BYTES(0,   0xB6,'P' ,'p' ),
    BYTES(0xB0,'[' ,0x5E,0x5E),
    BYTES(0xB1,']' ,0xA8,0xB8),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES(0x9B,0xBB,'N' ,'n' ),
    BYTES(0,   0xB5,'M' ,'m' ),
    BYTES(0xB8,0xAF,0x27,',' ),
    BYTES(0xF7,0xAD,0x22,'.' ),
    BYTES(0x96,0xB4,0xC9,0xE9),
    BYTES(0,   0,   0,   0  ),
    BYTES(',', '.', ',', '.'),
    BYTES('7', '7', '7', '7'),
    BYTES('8', '8', '8', '8'),
