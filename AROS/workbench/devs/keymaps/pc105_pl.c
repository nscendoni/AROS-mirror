/*
    ...
    $Id: pc105_pl.c 50780 2015-06-06 17:17:05Z polluks $
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0xA1, 0xB1, 'A', 'a'),		/* 20 */
    BYTES(0xA6, 0xB6, 'S', 's'),		/* 21 */
    BYTES('D', 'd', 'D', 'd'),		/* 22 */
    BYTES('F', 'f', 'F', 'f'), 		/* 23 */
    BYTES('G', 'g', 'G', 'g'), 		/* 24 */
    BYTES('H', 'h', 'H', 'h'), 		/* 25 */
    ...
    BYTES('|','\\', '|','\\'),	    	/* 30 */
    BYTES(0xAF, 0xBF, 'Z', 'z'),		/* 31 */
    BYTES(0xAC, 0xBC, 'X', 'x'),		/* 32 */
    BYTES(0xC6, 0xE6, 'C', 'c'),		/* 33 */
    BYTES('V', 'v', 'V', 'v'),		/* 34 */
    BYTES('B', 'b', 'B', 'b'),		/* 35 */
    BYTES(0xd1, 0xF1, 'N', 'n'),		/* 36 */
    BYTES('µ', 'µ', 'M', 'm'),		/* 37 */
