// Kbdusx_EnglishUnitedStatesExtended_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_usx.c 51236 2015-12-19 16:58:58Z polluks $
    
    Desc: US Extended PC105 Keymap
    Lang: Engslish
*/

#include "common.h"

DEFINE_KEYMAP("pc105_usx")
...
STATIC CONST IPTR lokeymap[] = {
    ...
    BYTES(0xD8,0xF8,'L' ,'l' ),
    BYTES(0xB0,0xB6,':' ,';' ),
    BYTES(0xA8,0xB4,0x22,0x27),
    BYTES(0xA6,0xAC,0x7C,0x5C),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
    BYTES('6', '6', '6', '6'),
