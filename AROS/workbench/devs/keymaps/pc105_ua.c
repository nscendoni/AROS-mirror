// Kbdur_Ucranian_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_ua.c 50780 2015-06-06 17:17:05Z polluks $
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0xA8,0xB8,0xA4,'\''),
    BYTES('!' ,'!' ,'!' ,'1' ),
    BYTES(0x22,0x22,0x22,'2' ),
    BYTES(0xB9,0xB9,0xB9,'3' ),
    BYTES(';' ,';' ,';' ,'4' ),
    BYTES('%' ,'%' ,'%' ,'5' ),
    BYTES(':' ,':' ,':' ,'6' ),
    BYTES('?' ,'?' ,'?' ,'7' ),
    ...
    BYTES('T' ,'t' ,0xC5,0xE5),
    BYTES('Y' ,'y' ,0xCD,0xED),
    BYTES(0xA5,0xB4,0xC3,0xE3),
    BYTES('I' ,'i' ,0xD8,0xF8),
    BYTES('O' ,'o' ,0xD9,0xF9),
    BYTES('P' ,'p' ,0xC7,0xE7),
    BYTES(0xD5,0xF5,0xD5,0xF5),
    BYTES(0xAF,0xBF,0xAF,0xBF),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES('L' ,'l' ,0xC4,0xE4),
    BYTES('U' ,'u' ,0xC6,0xE6),
    BYTES(0xAA,0xBA,0xAA,0xBA),
    BYTES(0x2F,0x5C,0x2F,0x5C),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
    BYTES('6', '6', '6', '6'),
    ...
    BYTES('N' ,'n' ,0xD2,0xF2),
    BYTES('M' ,'m' ,0xDC,0xFC),
    BYTES(0xC1,0xE1,0xC1,0xE1),
    BYTES(0xDE,0xFE,0xDE,0xFE),
    BYTES(',' ,'.' ,',' ,'.' ),
    BYTES(0,   0,   0,   0  ),
    BYTES(',', '.', ',', '.'),
    BYTES('7', '7', '7', '7'),
