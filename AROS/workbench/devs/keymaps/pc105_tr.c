/*
    ...
    $Id: pc105_tr.c 51235 2015-12-19 16:24:36Z polluks $
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES('Y' ,'y' ,'Y' ,'y' ),
    BYTES('U' ,'u' ,'U' ,'u' ),
    BYTES(0xDD,0xFD,'I' ,0xFD),
    BYTES('O' ,'o' ,'O' ,'o' ),
    BYTES('P' ,'p' ,'P' ,'p' ),
    BYTES(0xA8,0xA8,0xD0,0xF0),
    BYTES(0x7E,0x7E,0xDC,0xFC),
    BYTES(0  ,0   ,0   ,  0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES('¯' ,'­' ,'N' ,'n' ),
    BYTES('M' ,'m' ,'M' ,'m' ),
    BYTES(0xD6,0xF6,0xD6,0xF6),
    BYTES(0xC7,0xE7,0xC7,0xE7),
    BYTES(':' ,'.' ,':' ,'.' ),
    BYTES(0,   0,   0,   0  ),
    BYTES(',', ',', ',', ','),
    BYTES('7', '7', '7', '7'),
