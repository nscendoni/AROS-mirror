// Kbdir_EnglishIreland_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_irl.c 51236 2015-12-19 16:58:58Z polluks $

    Desc: English Irish PC105 Keymap
    Lang: English
*/

#include "common.h"

DEFINE_KEYMAP("pc105_irl")
...
STATIC CONST IPTR lokeymap[] ={
    ...
    BYTES(0x93,0x91,'L' ,'l' ),
    BYTES(0x94,0x92,':' ,';' ),
    BYTES(0x60,0xB4,'@' ,0x27),
    BYTES(0x5E,0x7E,0x7E,'#' ),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
    BYTES('6', '6', '6', '6'),
    /*---- 4th QWERTY row - 0x30 to 0x3F */
    BYTES(0,   0x7C,0x7C,0x5C),
    BYTES(0x87,0xA5,'Z' ,'z' ),
    BYTES(0xA4,0xD7,'X' ,'x' ),
    BYTES(0xC7,0xE7,'C' ,'c' ),
    BYTES(0x8B,0xAB,'V' ,'v' ),
