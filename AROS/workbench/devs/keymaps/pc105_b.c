// Kbdbe_FrenchBelgian_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_b.c 51236 2015-12-19 16:58:58Z polluks $

    Desc: Belgian French PC105 Keymap
    Lang: English
*/

#include "common.h"

DEFINE_KEYMAP("pc105_b")
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0x93,0x84,0xB3,0xB2),
    BYTES(0x94,0x7C,'1' ,'&' ),
    BYTES(0x99,'@' ,'2' ,0xE9),
    BYTES(0xB6,'#' ,'3' ,0x22),
    BYTES(0xA3,0xB0,'4' ,0x27),
    BYTES(0xBC,0xA7,'5' ,'(' ),
    BYTES(0xBD,0x5E,'6' ,0xA7),
    BYTES(0xBE,0xA2,'7' ,0xE8),
    BYTES(0,   0x83,'8' ,'!' ),
    BYTES(0,   '{' ,'9' ,0xE7),
    BYTES(0xAF,'}' ,'0' ,0xE0),
    BYTES(0xA6,0xB4,0xB0,')' ),
    BYTES(0x88,0x7E,'_' ,'-' ),
    BYTES(0x93,0x84,0xB3,0xB2),
    BYTES(0,   0,   0,   0  ),
    BYTES('0', '0', '0', '0'),
