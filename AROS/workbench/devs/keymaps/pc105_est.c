...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0xD3,0xF3,'O' ,'o' ),
    BYTES(0xD8,0xF8,'P' ,'p' ),
    BYTES(0x94,0x93,0xDC,0xFC),
    BYTES(0x92,0xA7,0xD5,0xF5),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES(0xD6,0xF6,'K' ,'k' ),
    BYTES('.' ,0xAC,'L' ,'l' ),
    BYTES(0xAF,0x85,0xD6,0xF6),
    BYTES(0xC6,0x5E,0xC4,0xE4),
    BYTES(0xBB,0xBD,'*' ,0x27),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
    BYTES('6', '6', '6', '6'),
