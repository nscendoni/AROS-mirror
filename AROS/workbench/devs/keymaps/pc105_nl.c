// Kbdne_DutchStandard_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_nl.c 51236 2015-12-19 16:58:58Z polluks $
    
    Desc: Dutch PC105 Keymap
    Lang: English
*/

#include "common.h"

DEFINE_KEYMAP("pc105_nl")
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0x93,0xAC,0xA7,'@' ),
    BYTES(0x94,0xB9,'!' ,'1' ),
    BYTES(0x99,0xB2,0x22,'2' ),
    BYTES(0xB6,0xB3,'#' ,'3' ),
    BYTES(0xA3,0xBC,'$' ,'4' ),
    BYTES(0,   0xBD,'%' ,'5' ),
    BYTES(0,   0xBE,'&' ,'6' ),
    ...
    BYTES(']' ,'}' ,')' ,'9' ),
    BYTES(0xAF,0,   0x27,'0' ),
    BYTES(0xA6,0x5C,'?' ,0x2F),
    BYTES(0x88,0xB8,0x7E,0xB0),
    BYTES(0x93,0xAC,0xA7,'@' ),
    BYTES(0,   0,   0,   0  ),
    BYTES('0', '0', '0', '0'),
    ...
    BYTES(0xD8,0xF8,'O' ,'o' ),
    BYTES(0xA1,0xBF,'P' ,'p' ),
    BYTES(0xB0,0x98,0x5E,0xA8),
    BYTES(0xB1,0x7E,0x7C,'*' ),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES(0,   0,   'K' ,'k' ),
    BYTES(0,   0xAC,'L' ,'l' ),
    BYTES(0x8C,0x9C,0xB1,'+' ),
    BYTES(0xC6,0xE6,0x60,0xB4),
    BYTES(0,   0,   '>' ,'<' ),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
