...
/*
    ...
    $Id: pc105_hr.c 51236 2015-12-19 16:58:58Z polluks $

    Desc: Croatian PC105 Keymap
    Lang: English
*/

#include "common.h"

DEFINE_KEYMAP("pc105_hr")
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES('Ø', 'ø', 'O' ,'o' ),
    BYTES('¶', '¶', 'P' ,'p' ),
    BYTES(0xF7,0xF7,0xA9,0xB9),
    BYTES(0xD7,0xD7,0xD0,0xF0),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES(0xB3,0xB3,'K' ,'k' ),
    BYTES(0xA3,0xA3,'L' ,'l' ),
    BYTES(0xC8,0xE8,0xC8,0xE8),
    BYTES(0xDF,0xDF,0xC6,0xE6),
    BYTES(0xA4,0xA4,0xAE,0xBE),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
    BYTES('6', '6', '6', '6'),
