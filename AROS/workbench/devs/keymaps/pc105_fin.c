// Kbdfi_Finnish_pkf.txt
/*
    Copyright © 1995-2011, The AROS Development Team. All rights reserved.
    $Id: pc105_fin.c 51236 2015-12-19 16:58:58Z polluks $

    Desc: Finnish PC105 Keymap
    Lang: English
*/

#include "common.h"

DEFINE_KEYMAP("pc105_fin")
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0xD8,0xF8,'O' ,'o' ),
    BYTES(0,   0xBF,'P' ,'p' ),
    BYTES(0xB0,0x98,0xC5,0xE5),
    BYTES(0xB1,0x7E,0x5E,0xA8),
    BYTES(0,   0,   0,   0  ),
    BYTES('1', '1', '1', '1'),
    BYTES('2', '2', '2', '2'),
    BYTES('3', '3', '3', '3'),
    ...
    BYTES(0,   0,   'K' ,'k' ),
    BYTES(0,   0xAC,'L' ,'l' ),
    BYTES(0x8C,0x9C,0xD6,0xF6),
    BYTES(0xC6,0xE6,0xC4,0xE4),
    BYTES(0,   0,   '*' ,0x27),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
