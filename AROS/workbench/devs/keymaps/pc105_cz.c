...
/*
    ...
    $Id: pc105_cz.c 51236 2015-12-19 16:58:58Z polluks $

    Desc: Czech PC105 Keymap
    Lang: English
*/

#include "common.h"

DEFINE_KEYMAP("pc105_cz")
...
STATIC CONST IPTR lokeymap[] =
{
    ...
    BYTES(0,   0,   0xB0,';' ),
    BYTES(0x7E,0x7E,'1' ,'+' ),
    BYTES(0xA1,0xA1,'2' ,0xEC),
    BYTES(0x5E,0x5E,'3' ,0x9A),
    BYTES(0xA2,0xA2,'4' ,0xE8),
    BYTES(0xB0,0xB0,'5' ,0xF8),
    BYTES(0xB2,0xB2,'6' ,0x9E),
    BYTES(0x60,0x60,'7' ,0xFD),
    BYTES(0xFF,0xFF,'8' ,0xE1),
    BYTES(0xB4,0xB4,'9' ,0xED),
    BYTES(0xBD,0xBD,'0' ,0xE9),
    BYTES(0xA8,0xA8,'%' ,'=' ),
    BYTES(0xB8,0xB8,0xA1,0xB4),
    BYTES(0,   0,   0xB0,';' ),
    BYTES(0,   0,   0,   0  ),
    BYTES('0', '0', '0', '0'),
    ...
    BYTES(0xA3,0xA3,'L' ,'l' ),
    BYTES('$' ,'$' ,0x22,0xF9),
    BYTES(0xDF,0xDF,'!' ,0xA7),
    BYTES(0xA4,0xA4,0x27,0xA8),
    BYTES(0,   0,   0,   0  ),
    BYTES('4', '4', '4', '4'),
    BYTES('5', '5', '5', '5'),
    BYTES('6', '6', '6', '6'),
