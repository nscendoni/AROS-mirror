...
static Object *app, *wnd, *listgad, *textgad1, *textgad2, *showgad,
    *hidegad, *cyclegad, *killgad;
...
static int Locale_Initialize(VOID)
{
    if (LocaleBase != NULL)
    {
        catalog = OpenCatalog(NULL, CATALOG_NAME, OC_Version,
            CATALOG_VERSION, TAG_DONE);
    }
    else
    {
        catalog = NULL;
...
static void update_list(void)
{
    ...
    ForeachNode(&brokerList, node)
    {
        ...
        DoMethod(listgad, MUIM_List_InsertSingle, node,
...
static void MakeGUI(void)
{
            ...
            WindowContents, (IPTR)(HGroup,
                Child, (IPTR)(VGroup,
                    ...
                    Child, (IPTR)(ListviewObject,
                        MUIA_Listview_List,
                            (IPTR)(listgad = (Object *)ListObject,
                            InputListFrame,
                ...
                Child, (IPTR)(VGroup,
                    ...
                    Child, (IPTR)(VGroup,
                        ...
                        Child, (IPTR)(textgad1 = (Object *)TextObject,
                            TextFrame,
                            MUIA_Background, MUII_TextBack,
                            End),
                        Child, (IPTR)(textgad2 = (Object *)TextObject,
                            TextFrame,
                            MUIA_Background, MUII_TextBack,
                            End),
                        End),
                    ...
                    Child, (IPTR)(ColGroup(2),
                        ...
                        Child, (IPTR)(cyclegad =
                            MUI_MakeObject(MUIO_Cycle, NULL, cyclestrings)),
                        Child, (IPTR)(killgad =
    ...
    DoMethod(hidegad, MUIM_Notify, MUIA_Pressed, FALSE,
        (IPTR)app, 3, MUIM_CallHook, (IPTR)&inform_broker_hook,
        CXCMD_DISAPPEAR);
