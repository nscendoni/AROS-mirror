/*
    ...
    $Id: yugoslavia.c 47219 2013-04-13 16:13:54Z NicJA $

    Desc: Country data for Jugoslavija (Yugoslavia)
*/

#include "country_locale.h"
#include <libraries/locale.h>

struct IntCountryPrefs yugoslaviaPrefs =
{
    {
        /* Reserved */
        { 0, 0, 0, 0 },
    ...
    "$VER: yugoslavia.country 44.0 (12.04.2013)",
    "Jugoslavija",
