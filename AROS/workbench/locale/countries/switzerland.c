/*
    ...
    $Id: switzerland.c 52794 2016-07-21 16:39:13Z polluks $

    Desc: Country data for Suisse / Svizzera / Schweiz (Switzerland)
...
struct IntCountryPrefs switzerlandPrefs =
{
    {
        /* Reserved */
        { 0, 0, 0, 0 },
    ...
    "$VER: switzerland.country 44.0 (12.04.2013)",
