/*
    ...
    $Id: france.c 52794 2016-07-21 16:39:13Z polluks $

    Desc: Country data for France
...
struct IntCountryPrefs francePrefs =
{
    {
        /* Reserved */
        { 0, 0, 0, 0 },
    ...
    "$VER: france.country 44.0 (12.04.2013)",
    NULL,
    "Countries/France"
};
