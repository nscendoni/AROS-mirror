/*
    ...
    $Id: norway.c 52794 2016-07-21 16:39:13Z polluks $

    Desc: Country data for Norge (Norway)
...
struct IntCountryPrefs norwayPrefs =
{
    {
        /* Reserved */
        { 0, 0, 0, 0 },
    ...
    "$VER: norway.country 44.0 (12.04.2013)",
    "Norge",
    "Countries/Norway"
};
