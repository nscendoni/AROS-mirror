/*
    ...
    $Id: sm502_init.c 51032 2015-08-29 22:49:55Z NicJA $
...
static int PCSM502_Init(LIBBASETYPEPTR LIBBASE)
{
    ...
    D(bug("[SM502] Init: Everything OK, installing driver\n"));
    ...
    if (!GfxBase)
    {
	D(bug("[SM502] Failed to open graphics.library!\n"));
    ...
    D(bug("[SM502] AddDisplayDriver() result: %u\n", err));
    if (!err)
    {
