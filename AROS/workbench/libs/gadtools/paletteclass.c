/*
    ...
    $Id: paletteclass.c 43432 2012-01-01 20:15:00Z jmcmullan $
...
IPTR GTPalette__GM_HANDLEINPUT(Class *cl, Object *o, struct gpInput *msg)
{
    ...
    {       
        ...
        if (x <= data->pd_PaletteBox.Left)
            x = data->pd_PaletteBox.Left + 1;
            
        if (y <= data->pd_PaletteBox.Top)
            y = data->pd_PaletteBox.Top + 1;
