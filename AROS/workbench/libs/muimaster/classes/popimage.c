...
IPTR Popimage__MUIM_Hide(struct IClass *cl, Object *obj,
    struct opGet *msg)
{
#if 0
    struct Popimage_DATA *data = INST_DATA(cl, obj);
...
IPTR Popimage__MUIM_Popimage_OpenWindow(struct IClass *cl, Object *obj,
    Msg msg)
{
    struct Popimage_DATA *data = INST_DATA(cl, obj);
    ...
    if (!data->wnd)
    {
        ...
        data->wnd = (Object *) WindowObject,
            ...
            WindowContents, (IPTR) VGroup,
                Child, (IPTR) (data->imageadjust =
                    MUI_NewObject(MUIC_Imageadjust,
                    MUIA_CycleChain, 1,
                ...
                Child, (IPTR) HGroup,
                    ...
                    Child, (IPTR) (ok_button = MUI_MakeObject(MUIO_Button,
                        (IPTR) "_Ok")),
                    Child, (IPTR) HVSpace,
                    Child, (IPTR) HVSpace,
                    Child, (IPTR) (cancel_button = MUI_MakeObject(MUIO_Button,
                        (IPTR) "_Cancel")),
                    End,
                End,
            End;
...
BOOPSI_DISPATCHER(IPTR, Popimage_Dispatcher, cl, obj, msg)
{
    ...
    {
    case OM_NEW:
        return Popimage__OM_NEW(cl, obj, (struct opSet *)msg);
    case OM_DISPOSE:
        return Popimage__OM_DISPOSE(cl, obj, msg);
    case MUIM_Hide:
        return Popimage__MUIM_Hide(cl, obj, (APTR) msg);
    case MUIM_Popimage_OpenWindow:
        return Popimage__MUIM_Popimage_OpenWindow(cl, obj, (APTR) msg);
    case MUIM_Popimage_CloseWindow:
        return Popimage__MUIM_Popimage_CloseWindow(cl, obj, (APTR) msg);
    case MUIM_DisconnectParent:
        return Popimage__MUIM_DisconnectParent(cl, obj, (APTR) msg);
    default:
