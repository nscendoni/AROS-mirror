...
#define IEEEDPMantisse_Mask_64 0x000FFFFFFFFFFFFFULL /* 52 bit for the mantisse */
#define IEEEDPExponent_Mask_64 0x7FF0000000000000ULL /* 11 bit for the exponent */
