/*
    ...
    $Id: strcasestr.c 48031 2013-09-08 21:16:04Z verhaegs $

    C extension function strcasestr().
*/
...
******************************************************************************/
{
	...
	if (tolower(*search) == tolower(*str))
	{
	    ...
	    */
	    while ((--done) && (tolower(*t) == tolower(*str)))
	    {
		/* Next character */
		t ++;
		str ++;
