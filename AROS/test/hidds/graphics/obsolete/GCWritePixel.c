/*
    ...
    $Id: GCWritePixel.c 33257 2010-05-14 10:07:42Z sonic $
...
/*****************************************************************************
    ...
    SYNOPSIS
        ...
        GCWritePixel HIDD/K,WIDTH/N/K,HEIGHT/N/K,DEPTH/N/K,CHUNKY/S,DISPLAYABLE=DP/S
    ...
    FUNCTION
        ...
        Creates a gc, writes some pixels and disposes
        the gc.
