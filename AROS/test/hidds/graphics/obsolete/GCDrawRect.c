/*
    ...
    $Id: GCDrawRect.c 33257 2010-05-14 10:07:42Z sonic $
...
/*****************************************************************************
    ...
    SYNOPSIS
        ...
        GCDrawRect HIDD/K,WIDTH/N/K,HEIGHT/N/K,DEPTH/N/K,CHUNKY/S,DISPLAYABLE=DP/S
    ...
    FUNCTION
        ...
        Creates a gc, draws some hollow and solid rects and
        disposes the gc.
                ...
                if(HiddGfxAttrBase && HiddBitMapAttrBase && HiddGCAttrBase)
                {
                    ...
                    if(gfxHidd)
                    {
                        ...
                        if(bitMap)
                        {
                            ...
                            if(gc)
                            {
                                HIDD_BM_DrawRect(gc, 10, 10, 30, 30);
                                HIDD_BM_FillRect(gc, 50, 15, 65, 25);

                                OOP_SetAttrsTags(gc, aHidd_GC_LinePattern, 0xF0F0, TAG_END);
                                HIDD_BM_DrawRect(gc, 10, 50, 50, 80);
