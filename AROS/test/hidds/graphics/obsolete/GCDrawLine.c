/*
    ...
    $Id: GCDrawLine.c 33257 2010-05-14 10:07:42Z sonic $
...
/*****************************************************************************
    ...
    SYNOPSIS
        ...
        GCDrawLine HIDD/K,WIDTH/N/K,HEIGHT/N/K,DEPTH/N/K,CHUNKY/S,DISPLAYABLE=DP/S
    ...
    FUNCTION
        ...
        Creates a gc, draws some lines with and without a pattern and
        disposes the gc.
