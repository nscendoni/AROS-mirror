/*
    ...
    $Id: GCCopyArea.c 33257 2010-05-14 10:07:42Z sonic $
...
/*****************************************************************************
    ...
    SYNOPSIS
        ...
        GCCopyArea HIDD/K,WIDTH/N/K,HEIGHT/N/K,DEPTH/N/K,CHUNKY/S,DISPLAYABLE=DP/S
    ...
    FUNCTION
        ...
        Creates a gc, copies the left, upper corner to the center of the
        gc and disposes the gc.
                ...
                if(HiddGfxAttrBase && HiddBitMapAttrBase && HiddGCAttrBase)
                {
                    ...
                    if(gfxHidd)
                    {
                        ...
                        if(bitMap)
                        {
                            ...
                            if(gc)
                            {
                                HIDD_BM_CopyArea(gc, 0, 0, gc, 140, 80, 40, 10);
