/*
    ...
    $Id: numericbutton.c 30792 2009-03-07 22:40:04Z neil $
*/
...
int main(void)
{
	...
	DoMethod(numbut, MUIM_Notify, MUIA_Numeric_Value, MUIV_EveryTime,
	...
	DoMethod(slider, MUIM_Notify, MUIA_Numeric_Value, MUIV_EveryTime,
	    	 (IPTR)numbut, 3, MUIM_NoNotifySet, MUIA_Numeric_Value, MUIV_TriggerValue);
